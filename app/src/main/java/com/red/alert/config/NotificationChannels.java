...
public class NotificationChannels {
    ...
    public static final String PRIMARY_ALERT_NOTIFICATION_CHANNEL_ID = "redalert_v2";
    public static final String PRIMARY_ALERT_NOTIFICATION_CHANNEL_NAME = "Alerts";

    // Secondary alerts notification channel config
    public static final String SECONDARY_ALERT_NOTIFICATION_CHANNEL_ID = "redalert_secondary_v2";
