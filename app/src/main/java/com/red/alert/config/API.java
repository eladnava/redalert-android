...
public class API {
    ...
    //public static String API_ENDPOINT = "http://192.168.43.48:3000";
    public static String API_ENDPOINT = "https://api.tzevaadom.app";

    // Define platform to be sent by our API
    public static String PLATFORM_IDENTIFIER = "android";

    // Define platform for Pushy self test
    public static String PUSHY_PLATFORM_IDENTIFIER = "pushy";
}
