...
public class Alerts {
    ...
    // Time to wait before calling finish() on AlertPopup after
    // POST_IMPACT_WAIT_MINUTES passed
    public static final int ALERT_POPUP_DONE_PADDING = 10;

    // Time that must pass (in seconds) in between alerts for the same zone (to
