...
public class MiBand {
    ...
    public MiBand(final Context context) {
        ...
        ActionCallback myConnectionCallback = new ActionCallback() {
            ...
            public void onSuccess(Object data) {
                Log.d(TAG, "Connection success and paired: " + data);
    ...
    public synchronized void notifyBandRepeated(final int flashColour, final int vibrateTimes, final int waitDuration) {
        List<BLEAction> list = new ArrayList<>();
